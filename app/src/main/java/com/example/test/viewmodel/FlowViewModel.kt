...
import com.example.test.data.repository.TestRepositoryImpl
...
class FlowViewModel @Inject constructor(
    ...
    private val switchGamesStateFlow : MutableStateFlow<ApiState<List<SwitchGamesApiInterface.Companion.SwitchGameData>>> = MutableStateFlow(
        ApiState.Loading()
    )
